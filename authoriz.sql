...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Янв 23 2024 г., 14:54
...
CREATE TABLE `users` (
  ...
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Иван',
...
(15, 'popa', '$2y$10$OQ6j4DJO.NR8m89r8Y1UCeLDEWfIDBErzbdmK6bHHw4LtYOyGzZZe', NULL, 'Алена', 1);
